...
export const DATA = {
  ...
  description: "Undergraduate student in Information Systems and Technology at Institut Teknologi Bandung (ITB)-Ganesha, passionate about project management and business development.",
  ...
  projects: [
    {
      ...
      links: [{ type: "Source", href: "https://github.com/13222093/tech-startup", icon: <Icons.github className="size-3" /> }],
      image: "/project.png",
      video: "",
    },
    {
      ...
      links: [{ type: "Source", href: "https://github.com/SalsabilaShofiyah/Dashboard-Tugas-Besar-II2211-Probabilitas-dan-Statistika", icon: <Icons.github className="size-3" /> }],
      image: "/project.png",
      video: "",
    },
    {
      ...
      links: [{ type: "Source", href: "https://github.com/abdurrahman-rafi/IF2050-2026-K02-G09-SIRUANG", icon: <Icons.github className="size-3" /> }],
      image: "/project.png",
      video: "",
    },
    {
      ...
      links: [{ type: "Source", href: "https://github.com/nicholasphalim/Tubes-OOP-K02-A", icon: <Icons.github className="size-3" /> }],
      image: "/project.png",
      video: "",
    },
    {
      ...
      links: [{ type: "Source", href: "https://github.com/SalsabilaShofiyah/watermarking", icon: <Icons.github className="size-3" /> }],
      image: "/project.png",
      video: "",
    },
    {
      ...
      links: [{ type: "Source", href: "https://github.com/SalsabilaShofiyah/Web-Portofolio-DRPL", icon: <Icons.github className="size-3" /> }],
      image: "/project.png",
      video: "",
    },
  ],
